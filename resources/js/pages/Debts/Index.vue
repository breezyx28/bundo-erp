...
const agingHeaders = [
    ...
    { key: 'current', label: t('debts.bucket.current'), class: 'text-end' },
    { key: 'd30', label: t('debts.bucket.d30'), class: 'text-end' },
    { key: 'd60', label: t('debts.bucket.d60'), class: 'text-end' },
    { key: 'd90', label: t('debts.bucket.d90'), class: 'text-end' },
    { key: 'total', label: t('purchasing.total'), class: 'text-end' },
];
    ...
    <AppLayout :title="t('nav.debts')">
        ...
        <div class="space-y-6">
            ...
            <UCard>
                ...
                <DataTable :headers="agingHeaders" :rows="aging" :query="filters" actions row-key="customer_id">
                    <template #toolbar>
                        <UInput
                    ...
                    <template #cell-current="{ value }"><span class="tabular-nums">{{ value }}</span></template>
                    <template #cell-d30="{ value }"><span class="tabular-nums text-warning">{{ value }}</span></template>
                    <template #cell-d60="{ value }"><span class="tabular-nums text-warning">{{ value }}</span></template>
                    <template #cell-d90="{ value }"><span class="tabular-nums text-error">{{ value }}</span></template>
                    <template #cell-total="{ value }"><span class="font-semibold tabular-nums">{{ value }}</span></template>
