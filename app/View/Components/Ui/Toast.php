        ...
        return <<<'HTML'
            <div>
                ...
                <div
                    ...
                    @ui-toast.window="start($event.detail.toast)"
                >
                    <div
                        class="toast !whitespace-normal fixed z-[999] cursor-pointer overflow-hidden"
                    ...
                    >
                        <div class="alert gap-3 border shadow-none" :class="toast.css">
                            <div x-html="toast.icon" class="hidden shrink-0 sm:inline-block"></div>
                            <div class="grid min-w-0 flex-1">
                                <div x-html="toast.title" class="text-sm font-semibold"></div>
                                <div x-html="toast.description" class="text-xs opacity-80"></div>
                            </div>
                        </div>
                        <progress
