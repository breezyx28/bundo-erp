                    ...
                    <fieldset class="fieldset py-0">
                        ...
                        @if ($slot->isNotEmpty())
                            ...
                            <div @click.prevent="" x-ref="crop" wire:ignore>
                                <x-ui-modal id="uiCrop{{ $uuid }}" x-ref="uiCrop" :title="$cropTitleText" separator class="backdrop-blur-sm" persistent @keydown.window.esc.prevent="" without-trap-focus>
                                    <img src="" />
                                    <x-slot:actions>
